...
function ModalPost() {
  ...
  const [modalPost, setModalPost] = useRecoilState<boolean>(modalPostState)
  ...
  return (
    <Transition.Root show={modalPost} as={Fragment}>
      <Dialog
        as="div"
        className="fixed inset-0 z-10 overflow-y-auto"
        onClose={setModalPost}
      >
        <div className="flex min-h-[800px] items-end justify-center px-4 pt-4 pb-20 text-center sm:block sm:min-h-screen sm:p-0">
          ...
          <Transition.Child
            ...
            enterTo="opacity-100 translate-y-4 sm:slace-100"
            leave="ease-in duration-200"
